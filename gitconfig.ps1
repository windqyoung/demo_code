...
git config --global --add alias.dfwd    "diff --src-prefix 'a: ' --dst-prefix 'b: ' --word-diff"
...
git config --global --add alias.dcwd    "diff --src-prefix 'a: ' --dst-prefix 'b: ' --cached --word-diff"
...
git config --global --add alias.pushot  "push --tags origin"
git config --global --add alias.pusho   "push origin"
